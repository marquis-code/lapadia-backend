...
export class DefinitionsFactory {
    static createForClass(target) {
        ...
        while (!isUndefined(parent.prototype)) {
            ...
            const schemaMetadata = TypeMetadataStorage.getSchemaMetadataByTarget(parent);
            if (!schemaMetadata) {
    ...
    static inspectTypeDefinition(optionsOrType) {
        if (typeof optionsOrType === 'function') {
            ...
            const schemaMetadata = TypeMetadataStorage.getSchemaMetadataByTarget(optionsOrType);
